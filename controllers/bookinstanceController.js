...
exports.bookinstance_list = function(req, res, next) {
  ...
  BookInstance.find()
    ...
    .exec(function (err, list_bookinstances) {
      ...
      res.render('bookinstance_list', { title: 'Listado de Copias', bookinstance_list: list_bookinstances });
    });
        ...
        if (!errors.isEmpty()) {
            ...
            Book.find({},'title')
                .exec(function (err, books) {
                    if (err) { return next(err); }
                    // Successful, so render.
                    res.render('bookinstance_form', { title: 'Nueva Copia', book_list : books, selected_book : bookinstance.book._id , errors: errors.array(), bookinstance:bookinstance });
            });
            return;
        }
        else {
...
exports.bookinstance_delete_get = function(req, res) {
    ...
    .exec(function (err, bookinstance) {
      if (err) { return next(err); }
      // Successful, so render.
      res.render('bookinstance_delete', { title: 'Eliminar Copia:', bookinstance:  bookinstance});
    })
